...
install_xcframework "${PODS_ROOT}/GoogleMobileAdsMediationFacebook/FacebookAdapter-6.6.0.0/FacebookAdapter.xcframework" "FacebookAdapter" "framework" "ios-arm64_armv7" "ios-x86_64-simulator"
