//
//  ProfileImageCameraViewController.swift
//  Actbind
//
...
final class ProfileImageCameraViewController: UIViewController {
    var section = 0
    ...
    @IBOutlet weak var goCamerarollButtonBackgroundView: UIView!
    ...
    override func viewDidLoad() {
        ...
        goCamerarollButtonBackgroundView.cornerAll(value: 0, fulcrum: "")
    ...
    @IBAction func goCamerarollButtonTouchUpInside(_ sender: Any) {
        UISelectionFeedbackGenerator().selectionChanged()
        
        let storyBoard = UIStoryboard(name: "ProfileImageCameraroll", bundle: nil)
        let nextVC = storyBoard.instantiateInitialViewController()
        let nav = (nextVC as? UINavigationController)
        let vc = (nav?.topViewController as! ProfileImageCamerarollViewController)
...
extension ProfileImageCameraViewController: AVCapturePhotoCaptureDelegate {
...
extension ProfileImageCameraViewController {
    // カメラの画質の設定
