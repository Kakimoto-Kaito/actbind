...
final class OtherProfilePostTableViewCell: UITableViewCell {
    ...
    func userData() -> OtherProfileViewController.OtherUsers {
        let userData = OtherProfileViewController.allOtherUsers[0]
        
        return userData
    }
    
    // ダミーのAPI
    var post: OtherProfileViewController.OtherPosts? {
