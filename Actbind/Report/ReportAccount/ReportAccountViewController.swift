...
final class ReportAccountViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    @IBOutlet weak var reportAccountTitleLabel: UILabel!
    @IBOutlet weak var reportAccountExplanationLabel: UILabel!
    @IBOutlet weak var reportTypeLabel: UILabel!
    @IBOutlet weak var reportTypePickerView: UIPickerView!
    @IBOutlet weak var sendButton: UIBarButtonItem!
    @IBOutlet weak var cancelButton: UIBarButtonItem!
    
    let reportType = ["akaunntohoukokutaipu1".localized(), "akaunntohoukokutaipu2".localized(), "akaunntohoukokutaipu3".localized(), "akaunntohoukokutaipu4".localized(), "akaunntohoukokutaipu5".localized(), "akaunntohoukokutaipu6".localized()]
    ...
    override func viewDidLoad() {
        ...
        reportAccountTitleLabel.text = "akaunntohoukokutaitoru".localized()
        reportAccountExplanationLabel.text = "houkokusetumei1".localized()
    ...
    @IBAction func sendButtonAction(_ sender: Any) {
        ...
        apiPostTheReportUser()
        dialog()
    }
    
    func apiPostTheReportUser() {
        let url = URL(string: api! + "reportuser")!
        ...
        let body = Post(userId: userId, reportType: reportTypePickerView.selectedRow(inComponent: 0) + 1)
        do {
            // EncodeしてhttpBodyに設定
