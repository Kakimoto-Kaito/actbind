...
final class PostTableViewCell: UITableViewCell {
    ...
    func userData() -> HomeViewController.Users {
        let userData = HomeViewController.allUsers[HomeViewController.allUsers.count - post!.userId]
        
        return userData
    }
    
    // ダミーのAPI
    var post: HomeViewController.Posts? {
    ...
    func cellNumber(indexPath: IndexPath) {
        if indexPath.row == 0 {
